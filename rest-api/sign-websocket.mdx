...
description: "Sign a TikTok WebSocket URL with X-Bogus parameters."
---

## `POST` `/webcast/sign_websocket`

Sign a TikTok WebSocket URL with X-Bogus parameters.
...
```
/webcast/sign_websocket?apiKey=YOUR_API_KEY
```
