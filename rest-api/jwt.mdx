...
description: "Generate a JWT token for secure frontend WebSocket connections."
---

## `POST` `/authentication/jwt`

Generate a JWT token for secure frontend WebSocket connections.
...
```
/authentication/jwt?apiKey=YOUR_API_KEY
```
