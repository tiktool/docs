---
title: "Sign URL"
description: "Sign any TikTok webcast URL with X-Bogus and X-Gnarly anti-bot parameters."
---

## `POST` `/webcast/sign_url`

Sign any TikTok webcast URL with X-Bogus and X-Gnarly anti-bot parameters.
...
```
/webcast/sign_url?apiKey=YOUR_API_KEY
```
